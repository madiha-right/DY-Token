...
contract IRToken is RTokenStructs, IERC20 {
     ...
     */
    function getAccountStats(address owner) external view returns (AccountStatsView memory);
     ...
     * @return hat stats
     */
    function getHatStats(uint256 hatID) external view returns (HatStatsView memory);
